...
/**
 * This is an example Reporter based on the Reserva object.  The reporter object
	...
	*/
	static function GetCustomQuery($criteria)
	{
		$sql = "select
			...
			,`reserva`.`idReserva` as Dreserva
			,`reserva`.`idCpf` as Dcpf
			,`reserva`.`idLivro` as Dlivro
		from `reserva`";
