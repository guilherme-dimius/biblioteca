...
require_once("DAO/ReservaCriteriaDAO.php");

/**
 * The ReservaCriteria class extends ReservaDAOCriteria and is used
 ...
 * @version 1.0
 */
class ReservaCriteria extends ReservaCriteriaDAO
{
