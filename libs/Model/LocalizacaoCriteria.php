...
require_once("DAO/LocalizacaoCriteriaDAO.php");

/**
 * The LocalizacaoCriteria class extends LocalizacaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class LocalizacaoCriteria extends LocalizacaoCriteriaDAO
{
