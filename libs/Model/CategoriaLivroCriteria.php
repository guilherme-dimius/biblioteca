...
require_once("DAO/CategoriaLivroCriteriaDAO.php");

/**
 * The CategoriaLivroCriteria class extends CategoriaLivroDAOCriteria and is used
 ...
 * @version 1.0
 */
class CategoriaLivroCriteria extends CategoriaLivroCriteriaDAO
{
