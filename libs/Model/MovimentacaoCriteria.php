...
require_once("DAO/MovimentacaoCriteriaDAO.php");

/**
 * The MovimentacaoCriteria class extends MovimentacaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class MovimentacaoCriteria extends MovimentacaoCriteriaDAO
{
