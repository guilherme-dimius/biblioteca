...
require_once("DAO/BloqueioCriteriaDAO.php");

/**
 * The BloqueioCriteria class extends BloqueioDAOCriteria and is used
 ...
 * @version 1.0
 */
class BloqueioCriteria extends BloqueioCriteriaDAO
{
