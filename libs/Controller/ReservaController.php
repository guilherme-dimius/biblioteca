...
class ReservaController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Dreserva,Dcpf,Dlivro'
				, '%'.$filter.'%')
			);
	...
	public function Read()
	{
		try
		{
			$pk = $this->GetRouter()->GetUrlParam('dreserva');
	...
	public function Create()
	{
		try
		{
			...
			// $reserva->Dreserva = $this->SafeGetVal($json, 'dreserva');

			$reserva->Dcpf = $this->SafeGetVal($json, 'dcpf');
			$reserva->Dlivro = $this->SafeGetVal($json, 'dlivro');
	...
	public function Update()
	{
		try
		{
			...
			// $reserva->Dreserva = $this->SafeGetVal($json, 'dreserva', $reserva->Dreserva);

			$reserva->Dcpf = $this->SafeGetVal($json, 'dcpf', $reserva->Dcpf);
			$reserva->Dlivro = $this->SafeGetVal($json, 'dlivro', $reserva->Dlivro);
