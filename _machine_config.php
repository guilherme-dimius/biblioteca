...
GlobalConfig::$CONNECTION_SETTING->DBName = "biblioteca";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "ShabbaotH749";
...
/** the root url of the application with trailing slash, for example http://localhost/sgb/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'biblioteca/';
